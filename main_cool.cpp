...
public:
    ...
    void showEntry(const HistoryEntry &e) {
        ...
        int dh = std::min(460, (int)resultBrowser->document()->size().height() + 52);
        setFixedSize(560, 158 + dh);
        lineEdit->hide();
...
private:
    ...
    void submitLine() {
        ...
        connect(timeout, &QTimer::timeout, this, [this, reply, timeout, pending]() mutable {
